...
// En el ejemplo tenemos un arreglo de elementos (fruits) y tenemos una variable asignada a count con la cual estamos utilizando el método some() 
// para validar si el arreglo cumple con la condición implementada, la cantidad sea mayor a 5.
